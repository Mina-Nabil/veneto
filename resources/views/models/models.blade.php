                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" style="padding:.1rem" class="btn btn-secondary" data-container="body" title="" data-toggle="popover" data-placement="bottom"
                                        data-content="{{$mod->MODL_CMNT}}" data-original-title="{{$mod->MODL_NAME}}">
                                        @endif
                                        {{$mod->MODL_NAME}}
                                    </button>
                                </td>
                                ...
                                <td>{{$mod->MODL_PRCE}}</td>
                                <td>{{$mod->COLR_NAME}}</td>
                                <td><a href="{{ url('models/edit/' . $mod->id) }}"><img src="{{ asset('images/edit.png') }}" width=25 height=25></a>
                                    @if($mod->MODL_HDDN)
                                    <button class="btn btn-success mr-2" onclick="confirmAndGoTo('{{ url('models/hide/' . $mod->id)}}', 'show this model')">Show</button>
                                    @else
                                    <button class="btn btn-danger mr-2" onclick="confirmAndGoTo('{{ url('models/hide/' . $mod->id)}}', 'hide this model')">Hide</button>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
                ...
                <form class="form pt-3" method="post" action="{{ $formURL }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <select name=type class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                ...
                                <option value="{{ $type->id }}" @if(isset($model) && $model->MODL_TYPS_ID == $type->id)
                                    selected
                                    @endif
                                    >
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <select name=supplier class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                ...
                                <option value="{{ $sup->id }}" @if(isset($model) && $model->MODL_SUPP_ID == $sup->id)
                                    selected
                                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <select name=color class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                ...
                                <option value="{{ $color->id }}" @if(isset($model) && $model->MODL_COLR_ID == $color->id)
                                    selected
                                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Model Name, Example: Cotton1 " class="form-control" name=name value="{{ (isset($model)) ? $model->MODL_NAME : old('name') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Model Meter Price, Example: 350 " class="form-control" name=price value="{{ (isset($model)) ? $model->MODL_PRCE : old('price') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Model Serial Number, Example: 19 " class="form-control" name=serial value="{{ (isset($model)) ? $model->MODL_UNID : old('serial') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="file" id="input-file-now-custom-1" name=photo class="dropify"
                                data-default-file="{{ (isset($model->MODL_IMGE)) ? asset( 'storage/'. $model->MODL_IMGE ) : old('photo') }}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Comment" class="form-control" name=comment value="{{ (isset($model)) ? $model->MODL_CMNT : old('comment') }}">
                        </div>
                    </div>

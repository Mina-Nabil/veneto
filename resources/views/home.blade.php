                ...
                <div class="card-body">
                    <table id="myTable" class="table color-bordered-table table-striped full-color-table full-info-table hover-table" data-display-length='-1' data-order="[]">
                        ...
                        <tfoot>
                            ...
                            <td>{{number_format($fullYearProd['totals']->totalCash, 2).'('. ($fullYearProd['totals']->totalPurch>0 && is_numeric($fullYearProd['totals']->totalPurch)) ? $fullYearProd['totals']->totalPurch*100 : 0}}</td>

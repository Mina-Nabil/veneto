...
<div class="card">
    <div class="card-body">
        <div class=row>
            ...
            <div class="col-lg-7">
                <h4 class="card-title">Via Veneto Operations</h4>
                <h6 class="card-subtitle">Show only Via Veneto Operations</h6>
            </div>
        </div>
        <div class="table-responsive m-t-40">
            <table id="myTable2"
...
<div class="card">
    <div class="card-body">
        <div class=row>
            ...
            <div class="col-lg-7">
                <h4 class="card-title">Production Sales Operations</h4>
                <h6 class="card-subtitle">Show only Production Sales Operations</h6>
            </div>
        </div>
        <div class="table-responsive m-t-40">
            <table id="myTable2"
...
<div class="card">
    <div class="card-body">
        <div class=row>
            ...
            <div class="col-lg-7">
                <h4 class="card-title">Procurement Sales Operations</h4>
                <h6 class="card-subtitle">Show only Procurement Sales Operations</h6>
            </div>
        </div>
        <div class="table-responsive m-t-40">
            <table id="myTable2"
